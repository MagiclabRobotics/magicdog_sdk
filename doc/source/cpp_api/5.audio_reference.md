...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    ...
    <tr><td>参数说明</td><td><code>config</code>：通过引用返回语音系统配置信息。</td></tr>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    ...
    <tr><td>参数说明</td><td><code>tts_type</code>：要切换的语音模型类型<br><code>config</code>：通过引用返回切换后的语音系统配置信息</td></tr>
    <tr><td>返回值</td><td><code>Status::OK</code> 表示成功，其他为失败状态。</td></tr>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    ...
    <tr><td>参数说明</td><td><code>cmd</code>：TTS 命令，包含文本、语速、语调等。</td></tr>
    <tr><td>返回值</td><td><code>Status::OK</code> 表示成功，其他为失败状态。</td></tr>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    ...
    <tr><td>参数说明</td><td><code>volume</code>：通过引用返回当前音量值。</td></tr>
    <tr><td>返回值</td><td><code>Status::OK</code> 表示成功，其他为失败状态。</td></tr>
