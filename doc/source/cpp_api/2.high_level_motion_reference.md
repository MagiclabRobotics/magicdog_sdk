...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    ...
    <tr><td>参数说明</td><td><code>gait_speed_ratios</code>：所有步态以及对应前进、横移、旋转速度比例。</td></tr>
    <tr><td>返回值</td><td><code>Status::OK</code> 表示成功，其他为失败。</td></tr>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    ...
    <tr><td>参数说明</td><td><code>gait_mode</code>：步态模式<br><code>gait_speed_ratio</code>：步态以及对应前进、横移、旋转速度比例</td></tr>
    <tr><td>返回值</td><td><code>Status::OK</code> 表示成功，其他为失败。</td></tr>
...
<table style="width: 100%; table-layout: fixed; border-collapse: collapse; text-align: left;">
  ...
  <tbody>
    ...
    <tr><td>参数说明</td><td><code>enabled</code>：返回参数，true表示已使能，false表示未使能。</td></tr>
    <tr><td>返回值</td><td><code>Status::OK</code> 表示成功，其他为失败。</td></tr>
