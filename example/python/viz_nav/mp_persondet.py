...
class MPPersonDet:
    ...
    def _postprocess(self, output_blob, original_shape, pad_bias):
        # OpenCV 4 returns (regression, scores); OpenCV 5 may swap output order.
        a, b = output_blob[0], output_blob[1]
        if a.shape[-1] == 1 and b.shape[-1] > 1:
            scores_blob, reg_blob = a, b
        else:
            reg_blob, scores_blob = a, b
        score = scores_blob[0, :, 0]
        box_delta = reg_blob[0, :, 0:4]
        landmark_delta = reg_blob[0, :, 4:]
